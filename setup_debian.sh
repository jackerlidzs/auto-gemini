...
echo "  python auto_batch.py        # For BitBrowser (Windows only)"
echo "  python auto_batch_dolphin.py # For Dolphin Anty (Linux)"
echo ""
echo "========================================"
echo "DOLPHIN ANTY SETUP (for Linux)"
echo "========================================"
echo ""
echo "1. Download Dolphin Anty for Linux:"
echo "   https://dolphin-anty.com/download"
echo ""
echo "2. Extract and run:"
echo "   tar -xzf DolphinAnty*.tar.gz"
echo "   ./DolphinAnty"
echo ""
echo "3. Create account at https://dolphin-anty.com"
echo "   Free tier: 10 profiles"
echo ""
echo "4. Enable Local API in Dolphin Anty settings"
echo "   Port: 3001 (default)"
echo ""
echo "5. Run automation:"
echo "   python auto_batch_dolphin.py"
echo ""
